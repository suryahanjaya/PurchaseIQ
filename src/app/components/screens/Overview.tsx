  ...
  return (
    <div className="px-4 md:px-8 py-5 md:py-8 max-w-[1280px] mx-auto space-y-4 md:space-y-6">
      ...
      <div className="bg-white rounded-2xl border border-slate-100 shadow-sm p-5 md:p-6">
        ...
        {/* Progress bars — hidden in Business view (too technical) */}
        {viewMode === "technical" && (
        ...
        >
          ...
          <p className="text-emerald-700 flex-1" style={{ fontSize: "12px", lineHeight: "1.5" }}>
            {viewMode === "business"
              ? <><strong>The model reliably identifies purchase intent</strong> — achieving 87.4% accuracy. Use it to focus your marketing on the users most likely to convert.</>
      ...
      {/* ── 3. MODEL INFORMATION + INFO CARDS ── */}
